...
export function Testimonials({
  testimonials,
  className,
  title = "Community Stories of Hope and Support",
  description = "Read inspiring stories and testimonials from students and individuals who overcame challenges and broke the stigma around mental health. Together, we build a stronger, supportive community.",
  maxDisplayed = 6,
}: TestimonialsProps) {
